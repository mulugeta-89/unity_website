    ...
    <div class="row">
        <div class="col-md-8">
            <p style="text-align: justify; color: white">
                ...
                In conclusion, as a father and your President, let me leave you with one piece of advice. Be convinced that education has no end. Knowledge is a spiral growth. Your graduation today should be a springboard for further studies. The world today calls for cut-throat competition. You should make yourselves ready for that by regularly updating your knowledge and skills. To this end, you can rely on your University for your continued higher education to the PhD level, which will be introduced in the near future. Hence, when you leave us today, we at Unity University do not say “Good bye!” We rather say “See you again!” Finally, I ask you to join me in wishing our country to come out of its current unparalleled challenges with success so that you can be of great help in contributing to its economic development. Once again, Congratulations! and God bless you all! Arega Yirdaw (PhD) President and CEO, Unity University
            </p>
        </div>
        <div class="col-md-4">
        <!-- Your image goes here -->
        <img src="{{asset("/unity_photos/arega.jpg")}}" class="img-fluid" alt="Image">
        </div>
    </div>
    </div>
</div>
