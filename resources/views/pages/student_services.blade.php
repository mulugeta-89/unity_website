      ...
      <div class="m-b30" id="curriculum">
        ...
        <div class="curriculum-list">
            <ul style="color: white" >
                ...
                <li>
                    <div class="curriculum-list-box">
                        <span>2. </span>Serve and monitor students to be safe and follow their education in a proper way by working with the Students’ Union
                    </div>
                </li>
                <li>
                    <div class="curriculum-list-box">
                        <span>3. </span>Send list of graduates to various organizations for job opportunities
                    </div>
                </li>
                <li>
                    <div class="curriculum-list-box">
                        <span>4. </span>Identify major students’ challenges and work for the solution
                    </div>
                </li>
                <li>
                    <div class="curriculum-list-box">
                        <span>5. </span>Work closely and smoothly with Alumni students on various issues to enhance and improve the quality of education and get different opportunities for both the Alumni members and the University
                    </div>
                </li>
            </ul>
        </div>
        <div class="curriculum-list">
            ...
            <ol style="color: white">
                ...
                <li>2.
                    To enhance the accomplishments of Community Service and Students’ Affairs issues by all possible ways
                </li>
                <li>3. To lead and monitor the activities of Community Service and Students’ Affairs duties in an organized way</li>
            </ol>
        </div>
      </div>
    </div>
