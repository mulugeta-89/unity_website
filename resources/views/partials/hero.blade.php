            ...
            <ul>	<!-- SLIDE  -->
                ...
                <li data-index="rs-100" 
                    ...
                    <img src="{{ asset("/unity_photos/pic1.jpg") }}" alt="" 
                        ...
                        class="rev-slidebg" 
                        data-no-retina 
                        style="max-height: calc(100vh - 200px);"/> <!-- Adjust 200px to the height of your footer -->
                    ...
                    <div class="tp-caption Newspaper-Title tp-resizeme" 
                        ...
                        data-hoffset="['0','0','0','0']" 
                        data-y="['top','top','top','top']" 
                        data-voffset="['50','50','50','40']" 
                        data-fontsize="['5vw','5vw','5vw','3vw']"
                        data-lineheight="['1.1','1.1','1.1','1.1']"
                        data-width="100%"
                        data-height="auto"
                        data-whitespace="normal"
                        data-type="text" 
                ...
                <li data-index="rs-200" 
                    ...
                    <!-- MAIN IMAGE -->
                    <img src="{{ asset("/unity_photos/pic4.jpg") }}" alt="" 
                        data-bgposition="center center" 
                        data-bgfit="cover" 
                        data-bgrepeat="no-repeat" 
                        data-bgparallax="10" 
                ...
                data-description="Science says that Women are generally happier">
                    ...
                    <div class="tp-caption Newspaper-Title   tp-resizeme" 
                        ...
                        data-paddingbottom="[10,10,10,10]"
                        data-paddingleft="[0,0,0,0]"
                        style="z-index: 6; font-family:rubik; font-weight:700; text-align:center; white-space: normal;text-transform:uppercase;margin-top: 190px">
                        <img src="{{asset("/unity_photos/unity_logo_home.jpg")}}"/>
                            <h1>
                            Welcome To Unity University
                            </h1>
                    </div>
